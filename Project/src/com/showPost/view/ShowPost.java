	...
	public class ShowPost {
		...
		public static void main(String[] args) {
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					try {
						ShowPost window = new ShowPost(null, null, null, null, 0);
		 ...
		 */
		public ShowPost(String userID, String writer, String title, String content, int boardNum) {
			this.userID = userID;
		...
		private void initialize(String writer, String title, String content) {
			...
			BackBtn.setBounds(146, 727, 97, 23);
